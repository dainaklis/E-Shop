    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <h3>Product Deatails <i class="fa fa-indent"></i></h3>
                <br>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vitae qui excepturi quibusdam ratione amet animi, maiores assumenda corrupti impedit officiis rerum perspiciatis, ea ipsum. In minus consequatur quas eos nisi!</p>
            </div>
        </div>
    </div>
